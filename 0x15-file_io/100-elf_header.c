...
/**
 * check_elf - will check if file is ELF file.
...
/**
 * print_magic - will print magic numbers of ELF header.
 * @e_ident: pointer to array containing ELF magic numbers.
 *
...
/**
 * print_class - will print class of ELF header.
...
/**
 *  * print_version - will print version of ELF header.
...
/**
 * print_osabi - will print OS/ABI of ELF header.
 * @e_ident: pointer to array containing ELF version.
 */
...
/**
 * main - will display information contained in
